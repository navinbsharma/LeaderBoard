...
import { getAjaxCallWithoutParams } from "../services/AjaxCall";
import ModalForSelectedTeam from './Modals/ModalForSelectedTeam';
        ...
        >
            {numSelected == 2 ? (
                <Typography className={classes.title} color="inherit" variant="subtitle1" component="div">
                    {numSelected} team selected. Make a Match.
                </Typography>
            ) :
                numSelected > 2 ? (
                    <Typography className={classes.title} variant="h6" id="tableTitle" component="div">
                        Please Deselect {numSelected - 2} team/teams to make a match
                    </Typography>
                ) : <Typography className={classes.title} variant="h6" id="tableTitle" component="div">
                        Please select {2 - numSelected} team/teams to make a match
            </Typography>}

            {numSelected == 2 ? (
                <Tooltip title="Compare">
                    <IconButton aria-label="delete">
                        <ModalForSelectedTeam rows={props.teamSelected} />
                    </IconButton>
                </Tooltip>
            ) : (
...
export default function EnhancedTable() {
    ...
    useEffect(() => {
        ...
        getAjaxCallWithoutParams(apiAuth, callback => {
            if (Object.keys(callback.data).length !== 0) {
                if ("errors" in callback.data) {
                    console.log(callback.data.error)
                }
    ...
    return (
        <div className={classes.root}>
            <Paper className={classes.paper}>
                <EnhancedTableToolbar numSelected={selected.length} teamSelected={selectedTeams}/>
                <TableContainer>
                    <Table
